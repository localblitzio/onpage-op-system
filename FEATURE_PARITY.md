...
- Cora Domain Lists: local and cloud now support synced CRUD/archive for tracked domains, competitors, banned domains, slow-render domains, and stop words. Native Windows Cora apply/pull actions are queued from cloud through the bridge; next check is real bridge execution.
